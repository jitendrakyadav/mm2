 ...
 */
 ...
 Create files in following orders. Please look every file's note where mentioned why that file has been created 
 i.e. what is purpose behind to crete that file:
 ...
 1. php bin/magento setup:upgrade && php bin/magento setup:di:compile && php bin/magento setup:static-content:deploy -f && php bin/magento cache:clean && php bin/magento cache:flush
 2. chmod -R 777 var generated pub/static
 3. rm -R var/cache/* var/page_cache/* var/view_preprocessed/* generated/* pub/static/*
 4. chmod -R 777 var generated pub/static
 5. If theme is not working properly, the again:
    php bin/magento setup:static-content:deploy -f

 How web-page looks like, please view following print-screen:
